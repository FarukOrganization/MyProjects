<%@ Page Title="" Language="C#" MasterPageFile="~/MCSMainMaster.master" AutoEventWireup="true" CodeFile="PurchaseReport.aspx.cs" Inherits="Reports_PurchaseReports_PurchaseReport" %>
...
<script type="text/javascript" language="javascript">
    ...
    function ViewReport() {
        ...
        window.open("../ReportViewer.aspx?report=purchaselistbydate&fromdate=" + fromdate.value + "&todate=" + todate.value);
