<%@ Page Title="" Language="C#" MasterPageFile="~/MCSMainMaster.master" AutoEventWireup="true"
    CodeFile="PurchaseFromBank.aspx.cs" Inherits="PurchaseFromBank" %>
...
//                alert($("input[type=text]")[currentindex + 1].getAttribute("id"));

//                var txtele=document.getElementById($("input[type=text]")[currentindex + 1].getAttribute("id"));
                //                alert(txtele.value);

                $("input[type=text]")[currentindex + 1].focus();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="98%" cellpadding="0" align="center" class="tblStyle">
        <tr>
            <td class="editmodetd">
                <asp:Label ID="lbleditmode" runat="server" Text="Purchase From Bank" SkinID="editmodelabelskin"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <table width="100%" class="tblStyleborderless" align="center">
                    <tr>
                        <td width="30%" valign="top">
                            <table width="100%">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <table width="100%">
                                                    <tr>
                                                        <td class="captiontd">
                                       <asp:HiddenField ID="hdnPurchaseGroupId" runat="server" />
                                                            <asp:Label runat="server" ID="lblBank" Text="Bank  "></asp:Label>
                                                        </td>
                                                        <td class="contenttd">
                                                            <asp:DropDownList runat="server" ID="drpBank" SkinID="largesizeddropdownlist" AutoPostBack="true"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="contenttd">
                                                            <asp:DropDownList ID="drpBranch" runat="server" SkinID="largesizeddropdownlist">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td class="textmandatory">
                                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td class="contenttd">
                                        <asp:TextBox runat="server" ID="txtAccountNo" SkinID="fullsizedtextbox"></asp:TextBox>
                                    </td>
                                    <td class="textmandatory">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td class="captiontd">
                                    <asp:Label runat="server" ID="lblPurchaseDate" Text="Purchase Date "></asp:Label>
                                    </td>
                                 <td class="contenttd">
                                 <asp:TextBox runat="server" ID="txtPurchaseDate"  SkinID="fullsizedtextbox"></asp:TextBox>
                                 </td>
                                 <td class="textmandatory"> 
                                 <%--<asp:RangeValidator ID="rvPurchaseDate" runat="server" ControlToValidate="txtPurchaseDate"
                        ...
                        <td width="25%" valign="top" align="left">
                            <table width="100%">
                              <asp:UpdatePanel runat="server" ID="updatepanelmoneyreciept">
                                <ContentTemplate>
                                <tr>
                                    <td class="captiontd">
                                  ...
                                  <Triggers>
                                      <asp:AsyncPostBackTrigger ControlID="drpBank" EventName="SelectedIndexChanged" />
                    ...
                    <tr>
                        <td colspan="3" align="left" width="60%">
                            ...
                            <ContentTemplate>
                            <asp:GridView ID="gvCurrenyPurchaseInfoList" runat="server" PageSize="5" Width="80%"
                                AutoGenerateColumns="False" AutoGenerateDeleteButton="True" 
                                    onrowdeleting="gvCurrenyPurchaseInfoList_RowDeleting">
                                <Columns>
                                    <asp:BoundField DataField="Id" HeaderText="PurchaseId">
        ...
        <tr>
            <td align="center" class="hp-link1" width="30%">
                <asp:LinkButton ID="lnkBtnLIst" runat="server" PostBackUrl="~/Purchase Forms/PurchaseInformationList.aspx" CausesValidation="False">Money&nbsp;Receipt&nbsp;List</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td>
