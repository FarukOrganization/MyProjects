<%@ Page Title="" Language="C#" MasterPageFile="~/MCSMainMaster.master" AutoEventWireup="true"
    CodeFile="PurchaseFromCustomer.aspx.cs" Inherits="PurchaseFromCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="98%" cellpadding="0" align="center" class="tblStyle">
        <tr>
            <td class="editmodetd">
                <asp:Label ID="lbleditmode" runat="server" Text="Purchase From Customer" SkinID="editmodelabelskin"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <table width="100%">
                               ...
                               <%-- <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td class="contenttd">
                                        <asp:DropDownList runat="server" ID="drpNationality" SkinID="largesizeddropdownlist">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="textmandatory">
                                    </td>
                                ...
                                <tr>
                                    <td class="captiontd">
                                        <asp:Label runat="server" ID="lblPassportNo" Text="Passport No "></asp:Label>
                                    </td>
                                    <td class="contenttd">
                                        <asp:TextBox runat="server" ID="txtPassportNo" SkinID="fullsizedtextbox"></asp:TextBox>
                                    </td>
                                    <td class="textmandatory">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="gvCurrenyPurchaseInfoList" runat="server" PageSize="5" Width="80%"
                                        AutoGenerateColumns="False" AutoGenerateDeleteButton="True" OnRowDeleting="gvCurrenyPurchaseInfoList_RowDeleting">
                                        <Columns>
