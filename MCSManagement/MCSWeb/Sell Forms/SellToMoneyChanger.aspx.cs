...
public partial class SellToMoneyChanger : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["SellGroupId"]))
            {
                ...
                if (dicSellInformation.Count > 0)
                {
                    ...
                    drpMoneyChanger.SelectedValue = dicSellInformation.Values.First().Cust_Id.ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        oSellInformation.CustomerType = (int)ECustomerType.MoneyChanger;
